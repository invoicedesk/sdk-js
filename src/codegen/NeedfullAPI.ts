...
import { IntegrationCallbacksAPI } from './services/IntegrationCallbacksAPI';
import { InvoiceAPI } from './services/InvoiceAPI';
import { InvoicePaymentsAPI } from './services/InvoicePaymentsAPI';
import { MediaAPI } from './services/MediaAPI';
import { ProductAPI } from './services/ProductAPI';
import { ProjectAPI } from './services/ProjectAPI';
import { RevenueReportAPI } from './services/RevenueReportAPI';
...
import { TaskTemplatesAPI } from './services/TaskTemplatesAPI';
...
export class NeedfullAPI {
  ...
  public readonly googleDrive: GoogleDriveAPI;
  public readonly integrationCallbacks: IntegrationCallbacksAPI;
  ...
  public readonly revenueReport: RevenueReportAPI;
  ...
  public readonly taskTemplates: TaskTemplatesAPI;
  ...
  constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = AxiosHttpRequest) {
    ...
    this.googleDrive = new GoogleDriveAPI(this.request);
    this.integrationCallbacks = new IntegrationCallbacksAPI(this.request);
    ...
    this.revenueReport = new RevenueReportAPI(this.request);
    ...
    this.taskTemplates = new TaskTemplatesAPI(this.request);
    this.team = new TeamAPI(this.request);
    this.timesheet = new TimesheetAPI(this.request);
    this.todos = new TodosAPI(this.request);
